      ...
      <article className="pt-20 bg-gray-50 dark:bg-gray-900 min-h-screen">
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-16 z-40">
          <div className="container mx-auto px-6 py-4">
            <button
              onClick={() => navigate('/news')}
              className="inline-flex items-center gap-2 text-navy-600 dark:text-yellow-400 hover:text-navy-700 dark:hover:text-yellow-300 transition-colors font-medium"
            >
              <ArrowLeft className="w-5 h-5" />
              Back to News
            </button>
